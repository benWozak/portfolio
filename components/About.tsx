...
export const About = (props: Props) => {
  ...
  return (
    <>
      ...
      <Flex w='100%' justify='center' alignItems='flex-start' direction='row' gap='2' mt='1rem'>
        <motion.div
        ...
        >
          <Stack spacing={8} direction={windowSize.width &&  windowSize.width < 1280 ? 'column' : 'row'}>
          <Flex
              justify='center'
              alignItems='center'
              direction='column'
            ...
            >
              <Box boxSize='sm' height='250px' display='flex' alignItems='flex-start' justifyContent='center'>
                <Image 
                  borderRadius='full'
                  boxSize='250px'
                  src={content.photo}
            ...
            >
                <ReactMarkdown 
                  ...
                  components={{
                    a: props => {
                        return (
                          <Link href={props.href} isExternal color="mainColor">{`@${props.children}`}</Link>
                        )
                    }
                }}
                >
      ...
      <Flex w='100%' justify='center' alignItems='center' direction='column' mb='10rem'>
        <Flex
          justify='center'
          alignItems='center'
          direction='row'
